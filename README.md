...
4. Modify bblayers.conf(located in ~/yocto/build/licheepizero/conf(or licheepizero_dock/conf)) PATH if necessary
...
5. Modify local.conf(located in ~/yocto/build/licheepizero/conf(or licheepizero_dock/conf)) file
